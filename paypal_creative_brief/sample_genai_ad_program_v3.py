...
for idx, generated_image in enumerate(
    ...
    headline_font = ImageFont.truetype(
        "/Users/garystafford/Library/Fonts/Montserrat-Bold.ttf", 27
    )
    ...
    headline_y = 20
    draw.text((headline_x, headline_y), headline, font=headline_font, fill="#157FFF", align="center")
    ...
    # Save the image
    img.save(f"generated_ads/paypal_generated_ad_v3_{idx + 1}.png", format="PNG")
